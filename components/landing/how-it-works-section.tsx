...
const steps = [
  {
    ...
    description: "Create your company profile and set up basic details. Begin your journey with a digital identity in minutes.",
  ...
  },
  {
    ...
    description: "Complete KYC to establish trust and credibility. Get a verified on-chain identity before legal incorporation.",
  ...
  },
  {
    ...
    title: "Register",
    subtitle: "& scale",
    description: "Register your company in your chosen jurisdiction. Manage operations, team, and documents as you grow.",
        ...
        <div className="relative mb-0 lg:mb-0 grid lg:grid-cols-2 gap-4 lg:gap-12 items-end">
          ...
          <div className="overflow-hidden pb-0 lg:pb-32">
            ...
            <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.85] transition-all duration-1000 delay-100 ${
              ...
              <span className="block text-white/10">Formalize.</span>
            </h2>
          </div>

          {/* Image cerisier — se colle en bas sur les blocs */}
          <div className={`relative h-80 lg:h-160 overflow-hidden transition-all duration-1000 delay-200 ${
