          ...
          <div className="grid lg:grid-cols-[auto_1fr] gap-8 lg:gap-16 items-stretch">
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className={`mt-8 text-xl text-muted-foreground leading-relaxed max-w-lg transition-all duration-1000 delay-100 ${
                ...
                Create a verifiable digital company identity instantly. 
                Choose any jurisdiction and upgrade to full legal incorporation when ready.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className={`lg:col-span-2 relative p-8 lg:p-12 border border-foreground/10 bg-foreground/2 overflow-hidden transition-all duration-700 ${
            ...
            <div className="absolute inset-0 opacity-70">
              ...
              {[...Array(20)].map((_, i) => (
                <div
                  key={i}
                  className="absolute w-1.5 h-1.5 rounded-full bg-[#7c1fee]"
                  style={{
                    left: `${10 + (i % 5) * 20}%`,
