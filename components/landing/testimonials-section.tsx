...
const asciiPattern = buildAsciiPattern(ASCII_ROWS, ASCII_COLS);
...
export function TestimonialsSection() {
  ...
  return (
    <section ref={sectionRef} className="relative py-32 lg:py-40 bg-foreground text-background overflow-hidden">
      ...
      <div className="absolute inset-0 font-mono text-[10px] text-background/2 leading-tight overflow-hidden whitespace-pre select-none">
        {asciiPattern}
      </div>
