...
const words = ["register", "verify", "incorporate", "launch"];
    ...
    <section className="relative min-h-screen flex flex-col justify-center items-start overflow-hidden bg-black">
      ...
      <div className="relative z-10 w-full max-w-350 mx-auto px-6 lg:px-12 py-32 lg:py-40">
        ...
        >
          <span className="inline-flex items-center gap-3 text-sm font-mono text-white/60">
           ...
           Decentralized Company Formation
          </span>
        </div>
        ...
        <div className="mb-12">
          ...
          >
            <span className="block whitespace-nowrap">Digital formation,</span>
      ...
      >
        <div className="max-w-350 mx-auto flex items-start gap-10 lg:gap-20">
          {[
            { value: "3500+", label: "businesses created" },
            { value: "99.7%", label: "verification success" },
